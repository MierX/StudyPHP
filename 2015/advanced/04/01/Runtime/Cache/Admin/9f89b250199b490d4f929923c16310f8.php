...
<html lang="">
    <head>
        ...
        <link href="/2015/advanced/04/01/index.php/../Admin/Public/css/admin.css" type="text/css" rel="stylesheet" />
        <title></title>
    </head>
    <body>
        <table align=center border=0 cellpadding=0 cellspacing=0 width="100%">
            <tr height=28>
                <td background=/2015/advanced/04/01/index.php/../Admin/Public/img/title_bg1.jpg>当前位置: </td></tr>
            <tr>
                <td bgcolor=#b1ceef height=1></td></tr>
            <tr height=20>
                <td background=/2015/advanced/04/01/index.php/../Admin/Public/img/shadow_bg.jpg></td></tr></table>
        <table cellspacing=0 cellpadding=0 width="90%" align=center border=0>
            <tr height=100>
                <td align="middle" width=100><img height=100 src="/2015/advanced/04/01/index.php/../Admin/Public/img/admin_p.gif"
                                                width=90 alt=""></td>
                <td width=60>&nbsp;</td>
                <td>
        ...
        <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
            ...
            <tr height=22>
                <td align='middle'
                    background=/2015/advanced/04/01/index.php/../Admin/Public/img/title_bg2.jpg style="padding-left: 20px; font-weight: bold; color: #ffffff">您的相关信息</td></tr>
